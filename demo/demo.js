...
app.get('/', async (req, res) => {
  ...
  write(`<html>`);
  write(`<head>`);
  write(`<title>interact</title>`);
  write(`</head>`);
  write(`<body>`);
  write(`<h1>interact <a href='/coverage'>Coverage</a> <a href='/docs'>Docs</a></h1>`);
  write(`<p>This library is available as JavaScript UMD module: <a href='/parsegraph-interact.js'>parsegraph-interact.js</a></p>`);
...
app.listen(port, () => {
  console.log(`See interact build information at http://localhost:${port}`);
});
